...
* The original package name 'com.example.refresh-scope-native' is invalid and this project uses 'com.example.refreshscopenative' instead.
...
```
$ docker run --rm -p 8080:8080 refresh-scope-native:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/refresh-scope-native
```
